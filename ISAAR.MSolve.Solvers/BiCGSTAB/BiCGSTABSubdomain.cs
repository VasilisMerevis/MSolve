...
namespace ISAAR.MSolve.Solvers
{
    public class BiCGSTABSubdomain : ISolverSubdomain
    {
        ...
        private Matrix2D<double> stiffnessMatrix;
        // REMOVE
        private Matrix2D<double> stiffnessMatrixCopy;
        private Vector<double> solution;

        public BiCGSTABSubdomain(Subdomain subdomain)
        {
        ...
        public IMatrix2D<double> Matrix
        {
            ...
            set
            {
                stiffnessMatrix = (Matrix2D<double>)value;
            }
        }
